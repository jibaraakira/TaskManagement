...
namespace ProjectDiary.Program.DAO
{
    ...
    public class CheckTodoDao
    {
        ...
        internal static List<CheckToDoTreeRow> GetTodoArray()
        {
            ...
            {
                new CheckToDoTreeRow() { StartDate = "2020-11-11", EndDate = "2020-11-12", Text = "Item1-1", IsExpanded = true, IsChecked = false, HierarchyPath = "0-0", HierarchyPathArray = new[] { 0, 0 } },
